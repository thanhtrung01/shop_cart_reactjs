    ...
    if (validator.isEmail(email)) {
      await axios
        ...
        .then(function (response) {
          ...
          // Save user json dsata to localStorage
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <label className="text-xs font-semibold px-1">Email<h1 className='ml-4 text-red-600 text-sm font-semibold text-center'>{errorMessage}</h1></label>
                    <div className="flex">
                      <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <button onClick={handleRegister} className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">
                      REGISTER NOW
                    </button>
                  </div>
                </div>
